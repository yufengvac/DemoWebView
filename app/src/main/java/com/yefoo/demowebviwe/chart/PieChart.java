...
public class PieChart extends View {
    ...
    private void drawPie(Canvas canvas, float amount) {
        ...
        canvas.drawArc(rectF, mStartAngle, mAngle, true, mPaint1);
        mStartAngle += mAngle;
    ...
    private void drawPieTouch(Canvas canvas, float amount) {
        ...
        RectF rectF = new RectF(centerX - mRadiusTemp, centerY - mRadiusTemp, centerX + mRadiusTemp, centerY + mRadiusTemp);
        canvas.drawArc(rectF, mStartAngle + mAngle * curtFractionTouch2,
